...
const Fitness = () => {
    ...
    useEffect(() => {
        fetch(`https://newserverreactblogapi.herokuapp.com/home/fitness`).then(res => res.json()).then
            (data => setData(data))
            ...
            <div className="mainContent">
                <div className="firstContent">
                    <Link to='/HomeImageOne'>
                        ...
                        {data.map((item, index) => {
                            return (
                                (item.id === "fit4pid30ff84") ? <div className="leftImg"><img src={item.img1} alt="Bollywood Images" height="100%" width="100%" /><div className="leftImgText">
                    ...
                    <div className="rightimg">
                        <Link to='/HomeImageOne'>
                            {data.map((item, index) => {
                                return (
                                    (item.id === "fit12pid30ff84") ? <div className="rightTop">
                        ...
                        <Link to='/HomeImageOne'>
                            {data.map((item, index) => {
                                return (
                                    (item.id === "fit12pid30ff84") ? <div className="rightSec">
                                        <img src={item.img1} alt="Bollywood Images" height="100%" width="100%" />
                                        <div className="rightTopText">
                                            <p className='rightTopTitleText'>{item.sub1} <br /> {item.Heading1}</p>
                                            <p className='rightTopsmallText'><span>{item.subh1}</span>{item.date1}</p>
